            ...
            <div class="login__content">
                <div class="login__left">
                    <ul class="login__left-list">
                        ...
                        <li class="login__left-item">
                            <form action="" class="login__left-form">
                                <div class="login__left-form-item">
                                    <label for="">Email(hoặc điện thoại) của bạn:</label>
                                    <input type="text" class="login__left-form-item-input">
                                </div>
                                <div class="login__left-form-item">
                                ...
                                <div class="login__left-form-item-check">
                                    ...
                                    <button class="login__left-form-item-button">Đăng nhập</button>
                                </div>
                            </form>
                        </li>
                ...
                <div class="login__right">
                    <ul class="login__left-list">
                        ...
                        <li class="login__left-item"><button class="login__left-form-item-button"><a href="./dangky.php">Đăng ký</a></button></li>
                    </ul>
                </div>
            </div>
        </div>
